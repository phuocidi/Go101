...
func handle(conn net.Conn) {
	// deferred function handles the panic and makes sure that in all cases the connection is closed
	defer func() {
...
// Write the data back out to the socket, echoing it to the client
